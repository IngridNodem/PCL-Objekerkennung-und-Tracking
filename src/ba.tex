...
\begin{itemize}
  ...
  \item \textbf{Visualisierung und Integration (Anforderungen~9~\&~10):} Rohdaten, Bodenfilter, Cluster und Tracks lassen sich in \texttt{RViz2} sowie der bestehenden GUI ohne spürbare Verzögerung darstellen. Die Verarbeitung bleibt auch bei wechselnden Betriebsmodi (Sensor, Sensor~+~PC, Sensor~+~PC~+~Embedded~PC) stabil, wodurch die Einbettung in die bestehende Messumgebung sichergestellt ist.
\end{itemize}
