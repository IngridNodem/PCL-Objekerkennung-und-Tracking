...
Die Konfiguration erfolgte über das Launch-File \textit{benchmark.launch.py}, welches alle Module innerhalb des gemeinsamen Namensraums \textit{/bench} startet. 
